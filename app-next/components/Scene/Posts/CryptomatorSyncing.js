      ...
      <div className="w-screen flex flex-col items-center" ref={docRef}>
        <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
          <img
            ...
            src={`/Assets/Blog/Cryptomator/header.png`}
            alt=""
          />
          ...
          <img
            ...
            src={`/Assets/Blog/Cryptomator/kali-cryptoperm.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          <img
            className={"my-4 rounded-xl"}
            src={`/Assets/Blog/Cryptomator/crypto-ma.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            Now, you can{" "}
          ...
          <img
            className={"my-4 rounded-xl"}
            src={`/Assets/Blog/Cryptomator/noncrypted.png`}
            alt=""
          />
          <img
            className={"my-4 rounded-xl"}
            src={`}/Assets/Blog/Cryptomator/crypted.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          <img
            className={"my-4 rounded-xl"}
            src={`/Assets/Blog/Cryptomator/keyadded.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            Now,{" "}

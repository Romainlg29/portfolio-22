      ...
      <div className="w-screen flex flex-col items-center" ref={docRef}>
        <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
          <img
            ...
            src={`/Assets/Blog/Deploy-MariaDB/header.png`}
            alt=""
          />
          <Paragraph>
            Docker brings great functionalities, however, with great
            functionalities comes great responsibility. Storing your data must
            be important at every step of a project. Moreover, GDRP must be
            respected to enter in the european market!
          </Paragraph>
          <Paragraph>
            Today, we're going to do a step by step install of a MariaDB on
            Docker Swarm!
          </Paragraph>
          <Paragraph>
          ...
          <Paragraph>
            Now, the question is where to store passwords that can be share on
            the network? The answer is Secret. Indeed, Docker brings a command
            that allow us to store secret and share it in the network.
          </Paragraph>
          <Paragraph>
            The command is{" "}
            <ParagraphImp setText={setInfoText}>
            ...
            . To follow the instructions provided by Docker, the most secure way
            is by writting it in a file instead of directly writing it in our
            termnial. To begin with, create a file to store the root password,
            ...
            , it'll remove all extra characters. Then you must simply execute

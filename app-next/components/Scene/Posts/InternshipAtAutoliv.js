...
const InternshipAtAutoliv = ({ title, date, id, isPhone }) => {
      ...
      <div className="w-screen flex flex-col items-center" ref={docRef}>
        <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
          <img
            ...
            src={`/Assets/Blog/Autoliv/header.png`}
          ...
          >
            <img
              src={`/Assets/Blog/Autoliv/connectToDatabase.png`}
              className={"my-2 shadow shadow-black rounded-xl"}
              alt=""
              style={{ gridArea: "1/1/3/2" }}
            />
            <img
              src={`/Assets/Blog/Autoliv/createPool.png`}
              className={"my-2 shadow shadow-black rounded-xl"}
              alt=""
              style={{ gridArea: "1/2/2/3" }}
            />
            <img
              src={`/Assets/Blog/Autoliv/req.png`}
              className={"my-2 shadow shadow-black rounded-xl"}
              alt=""
          ...
          <img
            className={"my-4 p-2 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Autoliv/mgh.png`}
          ...
          <img
            ...
            src={`/Assets/Blog/Autoliv/iis.png`}

      ...
      <div className="w-screen flex flex-col items-center" ref={docRef}>
        <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
          <img
            ...
            src={`/Assets/Blog/Map-Grafana/header.png`}
            alt=""
          />
          <Paragraph>
          ...
          <img
            ...
            src={`/Assets/Blog/Map-Grafana/select-map.png`}
            alt=""
          />
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`/Assets/Blog/Map-Grafana/sql-mode.png`}
            alt=""
          />
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`/Assets/Blog/Map-Grafana/layer-type.png`}
            alt=""
          />

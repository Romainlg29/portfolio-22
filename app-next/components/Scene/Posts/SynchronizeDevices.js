      ...
      <div className="w-screen flex flex-col items-center" ref={docRef}>
        <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
          <img
            ...
            src={`/Assets/Blog/Syncthing/header.png`}
          ...
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            Today, this article will deal with Syncthing and how to synchronize
            2 devices (Linux & Windows).
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/winkali.png`}
          ...
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/windowsWeb.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            A default folder is set, it’s by default located in your
            C:\users\%youruser%. However, you can create a new one by clicking
            on “Add Folder”. Firstly, you must set up the{" "}
            <span className={"font-bold"}>
              Folder ID, this ID is important, it must be the same on your
              synced devices to acces the folder.
            </span>{" "}
          ...
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/windowsCreateFolder.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            <span className={"font-bold"}>Full Rescan Interval</span> is the
            time between two lookups, a lower value will refresh your folder
            quite frequently.
          </p>
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            <span className={"font-bold"}>Folder Type</span> : define the
            folder’s type. Can send files, receive files or both.
          </p>
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            <span className={"font-bold"}>File Pull Order</span> : define the
            sync order. Newest First will sync the Newest files first.
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/windowsCreatefolderAdvanced.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            Once you did that, the{" "}
            <span className={"font-bold"}>Windows configuration is over.</span>{" "}
            If your other device is a Windows, skip the next part.
          </p>
          <p
            className={
              "mb-6 text-xl text-gray-700 text-center leading-8 font-bold"
          ...
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            ...
            and{" "}
            <span className={"font-bold"}>install the executable file.</span> If
            the program won’t run, open the file’s properties and click “Allow
            this file to run as a program”.
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow shadow-blue-400"}
            src={`/Assets/Blog/Syncthing/kaliInstall.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            The Linux’s configuration is now over. The next part will require
            both devices.
          </p>
          <p
            className={
          ...
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            ...
            <span className={"font-bold"}>get the ID of one device</span>{" "}
            (Actions on top right corner then Show ID).
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/getid.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            Then, you’ve to{" "}
            <span className={"font-bold"}>add a remote device</span> (Click on
            Add Remote Device), enter{" "}
            <span className={"font-bold"}>the previous ID</span> and set a{" "}
            <span className={"font-bold"}>name</span>.
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/setid.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            Now, go on the <span className={"font-bold"}>Sharing tab</span>,
            click on the{" "}
            <span className={"font-bold"}>desired folder to share</span> and
            click <span className={"font-bold"}>Save.</span>
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/sharefolder1.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            On your other device, you should{" "}
            <span className={"font-bold"}>receive a “notification”</span>, click
            on “<span className={"font-bold"}>Add Device</span>“. This should
            look like the next picture.
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/adddevicekali.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/sharefolder11.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            You should have{" "}
            <span className={"font-bold"}>a similar result</span> both devices.
          </p>
          <img
            className={"my-4 rounded-xl bg-white shadow"}
            src={`/Assets/Blog/Syncthing/result.png`}
            alt=""
          />
          <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
            You’re now at{" "}

    ...
    >
      ...
      <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
        ...
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          Between the May, 31st and June, 25th 2021, I made my first internship
          at Livbag, an Autoliv’s factory in the IT Service.
        </p>
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          In this internship, i mainly reworked an existing app. This app deals
          with the stock, the all the products that transit at Livbag. This app
          was originally made with PHP. It was unbelievably slow, that wasn’t a
          “real-time app”. So my internship supervisor, asked me if I wanted to
          rework this app from scratch with the language I want.
        </p>
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          I took React as the front-end library and Express as back-end. I chose
          these two because they are fast, easy to work with and easily
          upgradable.
        </p>
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
        ...
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          with a connection pool… The only way to solve this issue was to create
          our own ODBC package, but with the little time I was here, we didn’t.
          However, I handled most of the ODBC issues, with a lot of try / catch
          and verifications.
        </p>
        <div
        ...
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          The following render is the main stock page which was required with a
          lot of constraint on filters and data arrangement.
        </p>
        <img
          className={"my-4 p-2 rounded-xl bg-white shadow"}
        ...
        />
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          The app deployement took a bit of time because of React Router. Based
          on a Windows Server with IIS. Our browser was not correctly redirected
          to our pages. So, we’ve installed and configured a module named
          “urlrewrite” from Microsoft to handle React Router routes. After the
          installation, we just had to edit our web.config file and write the
          following code in.
        </p>
        <img

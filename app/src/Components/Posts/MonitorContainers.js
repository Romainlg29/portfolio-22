    ...
    >
      ...
      <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
        ...
        <Paragraph>
          ...
          the installation process with Docker! Moreover, I'll be using Traefik
          as a reverse proxy.
        </Paragraph>

        <Paragraph>
          First of all, we're going to create our architecture. Inside{" "}
          <ParagraphImp setText={setInfoText}>/etc/docker</ParagraphImp> you have to create two
          folders, one named stacks, and the other logs. The first one will
          contain all your apps and the seconds one will be used by Prometheus
          and Grafana.
        </Paragraph>
        <Paragraph>
          Now create two new <ParagraphImp setText={setInfoText}>docker-compose.yml</ParagraphImp> in
          two separate folders.
        </Paragraph>
        <Paragraph>
          Copy and paste the following code to the prometheus docker-compose.
          Note: As I'm using Traefik, my containers will be inside a predefined
          network, adjust this as your use case.
        </Paragraph>
        <CodeBlock>
          ...
          <CodeParagraph tab={8}>- "traefik.docker.network=netw"</CodeParagraph>
          <CodeParagraph tab={8}>- "traefik.backend=prometheus"</CodeParagraph>
        ...
        <Paragraph>
          In addition, we'll be adding the following code to our docker-compose
          to monitor cpu, ram... Just before our network retrieve field.
        </Paragraph>
        ...
        <Paragraph>
          ...
          wrote in our docker-compose (Not beside your docker-compose). And copy
          the following.
        </Paragraph>
        <CodeBlock>
          ...
          <CodeParagraph tab={6}>
            - targets: ['localhost:9090'] #Our logs will be collected as we're a
            target
          </CodeParagraph>
        ...
        <Paragraph>
          ...
          With <ParagraphImp setText={setInfoText}>docker service ls</ParagraphImp>, You should see
          your container working!
        </Paragraph>
        <Paragraph>
          Finally, let's get started with Grafana! Edit and paste the following
        ...
        <CodeBlock>
          ...
          <CodeParagraph tab={6}>- GF_USERS_ALLOW_SIGN_UP=false</CodeParagraph>
          <CodeParagraph tab={4}>expose:</CodeParagraph>
        ...
        <Paragraph>
          ...
          get a similar screen. Your credentials are the same as the one written

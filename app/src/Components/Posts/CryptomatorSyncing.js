  ...
  return (
    ...
    >
      ...
      <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
        ...
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          This short guide will be based on my previous guide about Syncing your
          devices easily with Syncthing. To begin with, we’ll be using
        ...
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          ...
          the file’s properties and click “Allow this file to run as a program”.
        </p>
        <img
        ...
        <p className={"mb-6 text-xl text-gray-700 text-center leading-8"}>
          This time, you’ve to <span className={"font-bold"}>Add a Vault</span>{" "}
          but you’ll{" "}
          <span className={"font-bold"}>click on Open Existing Vault</span>,
          then <span className={"font-bold"}>find your masterkey</span> which is
          located <span className={"font-bold"}>inside your synced folder</span>
          .
        </p>
        <img
          className={"my-4 rounded-xl"}

      ...
      <div className="w-screen flex flex-col items-center" ref={docRef}>
        <div className="w-11/12 lg:w-3/5 mt-2 md:mt-6">
          <img
            ...
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/header.png`}
            alt=""
          />
          <Paragraph>
          ...
          <img
            ...
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/dashboard-to-datasources.png`}
            alt=""
          />
          <Paragraph>
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/datasources-select.png`}
            alt=""
          />
          <Paragraph>
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/datasources-fields.png`}
            alt=""
          />
          <Paragraph>
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/create-dashboard.png`}
            alt=""
          />
          <Paragraph>
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/panel-builder.png`}
            alt=""
          />
          ...
          <img
            className={"my-4 rounded-2xl bg-white shadow-md"}
            src={`${process.env.PUBLIC_URL}/Assets/Blog/Stats-Mysql/panel-example.png`}
            alt=""
          />
          <Paragraph>
